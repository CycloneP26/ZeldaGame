...
public class Main extends JFrame {	
    private static JLabel keysLabelStatic; //key label
    private static JLabel rupeesLabelStatic; //rupee label
    private static int keysCount = 0; //# of keys
    private static int rupeesCount = 0; //# of rupees
    ...
    public void runGame() {
        ...
        bottomPanel.setPreferredSize(new Dimension(768, 50));
    ...
    private void createHealthLabel() {
        ImageIcon heartIcon = new ImageIcon(getClass().getResource("/objects/Heart.png"));

        healthLabel = new JLabel("<html><div style='text-align: center;'>-LIFE-<br>" +
                getHeartHtmlString(heartCount, heartIcon) + "</div></html>", JLabel.CENTER);

        healthLabel.setForeground(Color.RED);
        healthLabel.setFont(new Font("Courier New", Font.PLAIN, 36));
        healthLabel.setVerticalAlignment(SwingConstants.TOP);
        healthLabel.setVerticalTextPosition(SwingConstants.TOP);
        healthLabel.setHorizontalTextPosition(SwingConstants.CENTER);
