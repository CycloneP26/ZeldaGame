		...
		for(int i=0; i<r; i++)
		{
			...
			for(int j = 0; j<c; j++)
			{
				if(i==9 && j==0)
				{
					...
					tempRoom.addMobs(new Octorok(gp, 400, 100));
				...
				else if(i==9 && j==5)
				{
					...
					tempRoom.addMobs(new BlueOctorok(gp,600,100));
					tempRoom.addMobs(new BlueOctorok(gp,500,150));
					tempRoom.addMobs(new BlueOctorok(gp,300,100));
					tempRoom.addMobs(new BlueOctorok(gp,650,150));
					temp.add(tempRoom);
				}
				else if(i==9 && j==6)
				{
				...
				{
					Room tempRoom=new Room(gp, "939333939399399993933393939939993333333333333399333333333393333933933393933333333333333333933333339333939333333333333333339333393333333333333399999999999993339999999999999333999999999999933399");
					tempRoom.addMobs(new Moblin(gp,600,150));
					temp.add(tempRoom);
				}
				else if(i==0 && j==10)
				{
