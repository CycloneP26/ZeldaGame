...
public class RoomManager {
	...
	//creates a grid of rooms, with rows and columnmsm, with the rooms having different tiles, mobs, and items, 
	...
	//updates the current room based on the players movement
	//transitioning between rooms
	//updating the players position in the room
	public void update()
	{
	...
	//generates a new room based on the direction the character is traveling toward
	...
	//checks if a room is available based on the given row and column
	//returns false if the row/column is negative, greater than the room list
	//returns true if its available
