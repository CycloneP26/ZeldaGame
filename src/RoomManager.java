	...
	public RoomManager(GamePanel gp, int r, int c)
	{
		for(int i=0; i<r; i++)
		{
			...
			for(int j = 0; j<c; j++)
			{
				...
				{
					temp.add(new Room(gp, "11111111111333111111111111133311111111b33333333311111b33333333331ba1b3333333333333333333333333331dc1d3322222222211111d3222222222111111d222222222111111122222222211111112222222221111111222222222"));
				}
				else if(i==9 && j==5)
				{
					temp.add(new Room(gp, "111111111111111111111111111111113333333333333333333333333333333333333333333333333333333333333333333333333333333322222222222222222222222222222222222222222222222222222222222222222222222222222222"));
				}
				else if(i==9 && j==6)
				{
					temp.add(new Room(gp, "111111111111111111111111111111113333333333333333333333333333333333333333333333333333333333333333333333333333333322222222222222222222222222222222222222222222222222222222222222222222222222222222"));
				...
				{
					temp.add(new Room(gp, "11111111111111111111111111111111331111111111111133a1ba111ba1baba33333333333333333333333333333333222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222"));
					
				}
				else if(i==9 && j==8)
				{
					temp.add(new Room(gp, "111113333222222211111333322222221111133332222222ba11b3333222222233333333322222223333333332222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222"));
				}
				else if(i==0)
				{
