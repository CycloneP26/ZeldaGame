	...
	public RoomManager(GamePanel gp, int r, int c)
	{
		for(int i=0; i<r; i++)
		{
			...
			for(int j = 0; j<c; j++)
			{
				if(j==1 && i==1)
				{
					temp.add(new Room(gp, "555555533555555555558563355555555556333335555555556333333555555556333333375555553333333333333333553333333333335555333333333333555533333333333355553333333333335555555555555555555555555555555555"));
				}
				else if(i==1 && j==2)
				{
					temp.add(new Room(gp, "559393933939393955939393393939395533333333333333563333933939393363939333333333333333339339393933539393333333333355333393393939335533333333333333553333333333333355999999999999995599999999999999"));
				}
				else if(i==0)
				{
