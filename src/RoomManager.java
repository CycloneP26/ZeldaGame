		...
		for(int i=0; i<r; i++)
		{
			...
			for(int j = 0; j<c; j++)
			{
				...
				else if(i==9 && j==4)
				{
					...
					tempRoom.addMobs(new Zora(gp,400,400));
					tempRoom.setToCaveC(10);
				...
				else if(i==8 && j==4)
				{
					...
					tempRoom.addMobs(new BlueMoblin(gp,550,300));
					tempRoom.addMobs(new BlueMoblin(gp,200,100));
					tempRoom.addMobs(new BlueMoblin(gp,450,200));
					tempRoom.addMobs(new BlueMoblin(gp,550,300));
					tempRoom.addMobs(new Armos(gp,50,300));
					temp.add(tempRoom);
				}
				else if(i==0 && j==10)
				{
