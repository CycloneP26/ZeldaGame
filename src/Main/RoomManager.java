	...
	public RoomManager(GamePanel gp, int r, int c)
	{
		for(int i=0; i<r; i++)
		{
			...
			for(int j = 0; j<c; j++)
			{
				...
				{
					temp.add(new Room(gp, "939333939399399993933393939939999333333333333399933333333393333993933393933333339333333333933333939333939333333393333333339333399333333333333399999999999993339999999999999333999999999999933399"));
				}
				else if(i==7 && j==8)
				{
				...
				{
					temp.add(new Room(gp, "999399999999399999939999999939999993999999993999999399999999399933333333333333333333333333333333333333333333333399939999999939999993999999993999999399999999399999939999999939999993999999993999"));
				}
				else if(i==7 && j==5)
				{
					temp.add(new Room(gp, "999999999999999999999999999999993333333333333999999999999999399999999999999933339999999999993333999999999999333399999999999939993333399999993999999939999999399999993999999939999999399999993999"));
				}
				else if(i==7 && j==4)
				{
					temp.add(new Room(gp, "999999999999999993933393939933999333333333333333933333333393333993933393933333399333333333933339939333939333333993333333339333399333333333333333939333939399399993933393939939999393339393993999"));
				}
				else if(i==6 && j==7)
				{
					temp.add(new Room(gp, "999999999999999999999999999999999933333333333399933333333333333933333333333333393333333333333339333333333333333993333333333333399933333333333399999999999999999999999999999999999999999999999999"));
				}
				else if(i==6 && j==6)
				{
					temp.add(new Room(gp, "939393933939393993939393393939399333333333333339933333933339333993939333393339339333339333393333939393333933393393333393333933399333333333333339999399999999399999939999999939999993999999993999"));
				}
				else if(i==5 && j==6)
				{
